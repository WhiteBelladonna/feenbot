...
class gameTable():
    ...
    async def createTable(self, table):
        ...
        self.invite = await self.createInvite(self.category)
...
class Permissions():
    ...
    def __init__(self, server):
        ...
        self.groups = {
            ...
            "Gianni Ventrella": 699317720990351460,
            "Ralf Sandfuchs": 699317722093453403,
            "Sushi Art Bar": 699317722680393859,
            "Redaktion Phantastik GbR": 699317723792015431,
            "Aetherwelt Merchandise": 699317724332949565,
            "Black Mask Verlag": 699317725155164281,
            ...
            "NiederrheinCon 2020": 699317729169113149,
            "63": 699317729785675818,
            "Fallen World": 699317730867806340,
